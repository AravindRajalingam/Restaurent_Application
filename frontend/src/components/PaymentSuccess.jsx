      ...
      <div className="min-h-screen bg-base-200 flex items-center justify-center p-4">
        <div className="card w-full max-w-md bg-base-100 shadow-2xl rounded-2xl p-6 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Total Amount Paid: <span className="font-bold text-gray-900">{amount ? formatINR(amount) : "N/A"}</span>
          </p>
    ...
    return (
      <div className="min-h-screen bg-base-200 flex items-center justify-center p-4">
        <div className="card w-full max-w-md bg-base-100 shadow-2xl rounded-2xl p-6 text-center">
          ...
          <p className="text-gray-700 mb-6">
            You Have to Pay : <span className="font-bold text-gray-900">{amount ? formatINR(amount) : "N/A"}</span>
          </p>
